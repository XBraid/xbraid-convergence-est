...
void get_error_propagator_bound(const int bound, int theoryLevel, const int relax, Col<int> numberOfTimeSteps, Col<int> coarseningFactors, Col<double> **lambda, Col<double> *&estimate);
